                            ...
                            <Paper elevation={1} className='py-8 px-6 h-full'>
                                ...
                                <Box className='flex items-center justify-around'>
                                    <Box className='flex items-center'>
                                        <Box className='h-4 w-4 rounded-full mr-2' bgcolor={theme.palette.color.purplelight[500]} />
                                        <Typography variant="bodySmall">{__(`${module}.cards.card-2.fault`)}</Typography>
                                    </Box>
                                    <Box className='flex items-center'>
                                        <Box className='h-4 w-4 rounded-full mr-2' bgcolor={theme.palette.color.orange[200]} />
                                        <Typography variant="bodySmall">{__(`${module}.cards.card-2.leftovers`)}</Typography>
                                    </Box>
                                    <Box className='flex items-center'>
                                        <Box className='h-4 w-4 rounded-full mr-2' bgcolor={theme.palette.color.error[200]} />
                                        <Typography variant="bodySmall">{__(`${module}.cards.card-2.missing`)}</Typography>
                                    </Box>
                                </Box>
                            </Paper>
                        </Grid>
